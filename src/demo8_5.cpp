//
// Focus on 3D Terrain Programming - demo 8_5
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Fractal cloud generation: the skydome's cloud texture is generated
// procedurally with fractal Brownian motion instead of being loaded. Ported
...
{
	RETRO.title = "Demo 8_5: Fractal Cloud Generation";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo8_5::DEMO_Initialize() Unable to load detail map\n");
	}
	...
	camera.SetPosition(128.0f, 300.0f, 256.0f);

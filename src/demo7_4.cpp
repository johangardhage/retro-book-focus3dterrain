//
// Focus on 3D Terrain Programming - demo 7_4
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Full ROAM with split/merge priority queues: a frame-coherent ROAM that
// incrementally refines and coarsens the mesh each frame toward a target
// triangle count. Ported from the original Win32/OpenGL demo to SDL3.
//
...
{
	RETRO.title = "Demo 7_4: Adding the Split/Merge Priority Queue";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo7_4::DEMO_Initialize() Unable to load detail map\n");
	}
...
void DEMO_Render(double deltatime)
{
	...
	// Process the split/merge queues and render the terrain

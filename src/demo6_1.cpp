//
// Focus on 3D Terrain Programming - demo 6_1
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// A simple quadtree terrain engine: a top-down quadtree selects a per-node
// level of detail, rendered as triangle fans. Press T to toggle texturing, B
// to toggle the detail map. Ported from the original Win32/OpenGL demo to SDL3.
//
...
{
	RETRO.title = "Demo 6_1: Creating a Simple Quadtree Terrain Engine";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo6_1::DEMO_Initialize() Unable to load detail map\n");
	}

//
// Focus on 3D Terrain Programming - demo 8_7
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Simple hardware fog: linear OpenGL fog is added over the terrain/water/sky
// scene (with camera-terrain collision). Ported from the original Win32/OpenGL
// demo to SDL3.
//
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo8_7::DEMO_Initialize() Unable to load detail map\n");
	}

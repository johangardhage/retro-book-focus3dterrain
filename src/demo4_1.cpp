//
// Focus on 3D Terrain Programming - demo 4_1
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Height-based lighting. The terrain (generated color texture + detail map)
// is shaded per-vertex by its height. Press T to toggle texturing, B to toggle
// the detail map. Ported from the original Win32/OpenGL demo to SDL3.
//
...
{
	RETRO.title = "Demo 4_1: Height-Based Lighting";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo4_1::DEMO_Initialize() Unable to load detail map\n");
	}
	...
	// Set up height-based lighting
	terrain.SetLightingType(HEIGHT_BASED);

//
// Focus on 3D Terrain Programming - demo 8_4
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Life in the skydome: a split/merge ROAM terrain with simulated water under a
// textured, slowly rotating skydome. Ported from the original Win32/OpenGL
// demo to SDL3.
//
...
{
	RETRO.title = "Demo 8_4: Life in the Skydome";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo8_4::DEMO_Initialize() Unable to load detail map\n");
	}
	...
	skydome.LoadTexture("assets/clouds.tga");

//
// Focus on 3D Terrain Programming - demo 6_2
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Adding roughness propagation: the quadtree applies more triangles to the
// rougher areas of the terrain. Press T to toggle texturing, B to toggle the
...
{
	RETRO.title = "Demo 6_2: Adding Roughness Propagation";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo6_2::DEMO_Initialize() Unable to load detail map\n");
	}

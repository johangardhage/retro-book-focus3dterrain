//
// Focus on 3D Terrain Programming - demo 8_2
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Realistic water with terrain: a split/merge ROAM terrain with an animated,
// simulated water mesh (sphere-mapped reflection) laid over it. Ported from
// the original Win32/OpenGL demo to SDL3.
//
...
{
	RETRO.title = "Demo 8_2: Realistic Water with Terrain";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo8_2::DEMO_Initialize() Unable to load detail map\n");
	}
	...
	camera.SetPosition(128.0f, 512.0f, 256.0f);

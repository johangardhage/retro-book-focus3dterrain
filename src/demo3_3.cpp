//
// Focus on 3D Terrain Programming - demo 3_3
//
// Author: Johan Gardhage <johan.gardhage@gmail.com>
//
// Using a detail map. A generated texture map is combined with a tiled detail
// map for close-up surface detail. Press T to toggle texturing and B to toggle
...
{
	RETRO.title = "Demo 3_3: Using a Detail Map";
...
void DEMO_Initialize(void)
{
	...
	if (!terrain.LoadDetailMap("assets/detailmap.tga")) {
		RETRO_RageQuit("[ERROR] Demo3_3::DEMO_Initialize() Unable to load detail map\n");
	}
